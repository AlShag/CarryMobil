...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('full_road', models.CharField(max_length=300, verbose_name='Маршрут')),
                ...
                ('cargo_type', models.CharField(blank=True, max_length=50, verbose_name='Тип груза')),
                ...
                ('sended_in', models.DateTimeField(blank=True, default=datetime.datetime(2021, 3, 4, 14, 5, 20, 938520), null=True, verbose_name='Время отправки заявки')),
