# Generated by Django 3.1.4 on 2021-06-13 14:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sended_in', models.DateTimeField(blank=True, default=datetime.datetime(2021, 6, 13, 17, 15, 53, 320017), null=True, verbose_name='Время отправки заявки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sended_in', models.DateTimeField(blank=True, default=datetime.datetime(2021, 6, 13, 17, 15, 53, 330021), null=True, verbose_name='Время отправки заявки')),
                ('author', models.IntegerField(blank=True, default=0, null=True, verbose_name='ID Автора')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prices', models.CharField(blank=True, max_length=150, null=True, verbose_name='Цены заказа')),
                ('user_tel_nomer', models.CharField(max_length=20, verbose_name='Номер телефона заказчика')),
                ('sended_in', models.DateTimeField(blank=True, default=datetime.datetime(2021, 6, 13, 17, 15, 53, 318018), null=True, verbose_name='Время отправки заявки')),
                ('status', models.IntegerField(blank=True, default=0, null=True, verbose_name='Состояние заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.driverprofile')),
            ],
        ),
    ]
